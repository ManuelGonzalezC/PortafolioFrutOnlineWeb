...
def telefono_int(value): 
    if value.isdigit()==False:
        raise ValidationError('Teléfono no válido, ingrese solo datos numéricos')

def rut_int(value): 
    if value.isdigit()==False:
        raise ValidationError('RUT no válido, ingrese su RUT completo sin guión')
